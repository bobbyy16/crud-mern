...
export default function Products({products}) {
  ...
  const handleDelete = (id) => {
    products.filter(() => id !== products._id)
  }
  ...
  return (
    ...
    <div className="bg-white rounded shadow-lg overflow-hidden">
            ...
            <div className="mt-2 flex gap-4">
                ...
                <button onClick={() => handleDelete(_id)}  className="inline-block w-full text-center shadow-md text-sm bg-red-700 text-white rounded-sm px-4 py-1 font-bold hover:bg-red-600 hover:cursor-pointer">Delete</button>
            </div>
